...
function loadDownloadLinkDependingOnOsArchitechture() {
  ...
  if (navigator.platform.includes('MacIntel')) {
    $('#softwarep-age-button-container').css('display', 'flex');
    $('#software-download-button').attr("href", "https://das-keyboard-q-releases.s3.us-east-2.amazonaws.com/das-keyboard-q/darwin/arm64/Das+Keyboard+Q-4.0.3-arm64.dmg");
   ...
   $('#software-download-button-intel').attr("href", "https://das-keyboard-q-releases.s3.us-east-2.amazonaws.com/das-keyboard-q/darwin/x64/Das+Keyboard+Q-4.0.3-x64.dmg");
  ...
  if (navigator.platform.includes('Linux x86_64')) {
    $('#softwarep-age-button-container').css('display', 'flex');
    $('#software-download-button').attr("href", "https://das-keyboard-q-releases.s3.us-east-2.amazonaws.com/das-keyboard-q/linux/x64/das-keyboard-q_4.0.3_amd64.deb");
    $('#software-download-button').append(" 64 bit");
    $('#software-version-number').append('Version 4.0.3');
