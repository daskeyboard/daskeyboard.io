...
<!-- copy button -->
<a class="btn btn-sm copy-action"  data-toggle="tooltip" data-placement="top" title="copy" onclick="copyToClipBoard('delete-signal-by-zone-id-shell-local')"><i class="fa fa-copy"></i></a>
...
<!-- copy button -->
<a class="btn btn-sm copy-action" data-toggle="tooltip" data-placement="top" title="copy"  onclick="copyToClipBoard('delete-signal-by-zone-id-node-local')"><i class="fa fa-copy"></i></a>
...
<!-- copy button -->
<a class="btn btn-sm copy-action" data-toggle="tooltip" data-placement="top" title="copy"  onclick="copyToClipBoard('delete-signal-by-zone-id-python-local')"><i class="fa fa-copy"></i></a>
