...
export PATH="../../../flutter-app/flutter/bin/cache/dart-sdk/bin:$PATH"
...
if [ "$ENABLE_PR_BOT" = "true" ]; then
    if [ "$BRANCH" != "master" ]; then
        ...
        cd tool/
        ../../../flutter-app/flutter/bin/cache/dart-sdk/bin/pub get
        export PROJECT_NAME=`../../../flutter-app/flutter/bin/cache/dart-sdk/bin/dart prdeployer.dart $BRANCH $FIREBASE_AUTH 2>&1`
        cd ../
