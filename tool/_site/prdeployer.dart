...
String firebaseRoot = "https://q-website-fafc7.firebaseio.com/q-website/pulls";
...
Future<List<PullRequest>> getPullRequests() async {
  Stream<PullRequest> pullRequests = await github.pullRequests.list(new RepositorySlug.full("DasKeyboard/q-website"));
...
Future<IssueComment> postLinkToGithub(String projectToDeploy, PullRequest request) async {
  ...
  IssueComment issueComment = await github.issues.createComment(
      new RepositorySlug.full("DasKeyboard/q-website"),
      request.number,
