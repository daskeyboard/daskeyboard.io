...
[![Build Status](https://travis-ci.com/metadot/metadot.github.io.svg?token=sBrjsq524qva4V6vzxWH&branch=master)](https://travis-ci.org/metadot/metadot.github.io)
...
* A snippet without any import statements will have an import
  (`'package:metadot.github.io/material.dart'`)
