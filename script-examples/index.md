...
* [Create signal to the cloud]({{site.baseurl}}/script-examples/send-signal-to-cloud/)
* [Create signal to the public API]({{site.baseurl}}/script-examples/send-signal-local/)
